...
<table cellpadding="0" cellspacing="0" class="table6col">
	...
	<tr>
		...
		<td class="c2" nowrap="true">
			<My:IntegerTextBox ID="IntegerTextBoxDefaultValue" CssClass="textboxShort" runat="server" />
		</td>
		<td class="c1" nowrap="nowrap"><%= Resources.ExtensionModel.MinValue%>: </td>
		<td class="c2" nowrap="true">
			<My:IntegerTextBox ID="IntegerTextBoxMinValue" CssClass="textboxShort" runat="server" />
		</td>
		<td class="c1" nowrap="nowrap"><%= Resources.ExtensionModel.MaxValue%>: </td>
		<td class="c2" nowrap="true">
			<My:IntegerTextBox ID="IntegerTextBoxMaxValue" CssClass="textboxShort" runat="server" />
		</td>
	</tr>
	<tr>
