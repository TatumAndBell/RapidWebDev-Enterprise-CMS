...
<table cellpadding="0" cellspacing="0" class="table6col">
	...
	<tr>
		...
		<td class="c2" nowrap="true">
			<My:TextBox ID="TextBoxDefaultValue" CssClass="textboxShort" runat="server" />
		</td>
		<td class="c1" nowrap="nowrap"><%= Resources.ExtensionModel.MinLength%>: </td>
		<td class="c2" nowrap="true">
			<My:IntegerTextBox ID="IntegerTextBoxMinLength" CssClass="textboxShort" AllowNegative="false" runat="server" />
		</td>
		<td class="c1" nowrap="nowrap"><%= Resources.ExtensionModel.MaxLength%>: </td>
		<td class="c2" nowrap="true">
			<My:IntegerTextBox ID="IntegerTextBoxMaxLength" CssClass="textboxShort" AllowNegative="false" runat="server" />
		</td>
	</tr>
	<tr>
		<td class="c1" nowrap="nowrap"><%= Resources.ExtensionModel.Regex%>: </td>
		<td class="span" colspan="5" nowrap="true">
			<My:TextBox ID="TextBoxRegex" CssClass="textboxLong" runat="server" />
		</td>
	</tr>
	<tr>
